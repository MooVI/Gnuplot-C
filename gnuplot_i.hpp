...
class Gnuplot
{
    ...
    /// plot x,y pairs: x y
    ///   from file
    Gnuplot& plotfile_x_general(const std::vector<PlotterData>& data);
    Gnuplot& plotfile_xy_general(const std::vector<PlotterData>& data);
    Gnuplot& plotfile_xyz_general(const std::vector<PlotterData>& data);
    ///   from data
