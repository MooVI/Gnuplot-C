...
${OBJECTDIR}/Plotter.o: Plotter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../boost\ linux -I../../CASexperiment/CASLinux/Files -I../.. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Plotter.o Plotter.cpp

${OBJECTDIR}/PlotterStruct.o: PlotterStruct.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../boost\ linux -I../../CASexperiment/CASLinux/Files -I../.. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PlotterStruct.o PlotterStruct.cpp

${OBJECTDIR}/gnuplot.o: gnuplot.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../boost\ linux -I../../CASexperiment/CASLinux/Files -I../.. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gnuplot.o gnuplot.cpp
